package com.greenhelix.pear.selectPear;
...
public class SelectPearActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(doubleBackToExitPressedOnce){
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(SelectPearActivity.this);
            builder.setTitle("알림");
            ...
            builder.setPositiveButton("종료", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    ActivityCompat.finishAffinity(SelectPearActivity.this);
                }
