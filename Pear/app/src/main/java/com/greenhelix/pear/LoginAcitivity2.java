...
class LoginActivity2   extends AppCompatActivity {
    // xml 버튼 할당
        ...
        fAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    updateUI(user);
                    Toast.makeText(LoginActivity2.this,"성성공공 FirebaseGoogleAuth",Toast.LENGTH_SHORT).show();
                }else{
                    updateUI(null);
                    Toast.makeText(LoginActivity2.this,"실실패패 FirebaseGoogleAuth",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//                    ,Toast.LENGTH_SHORT).show();
            Intent access = new Intent(LoginActivity2.this, MainActivity.class);
            access.putExtra("email",personEmail);
